const CPABEEncryption = artifacts.require("EncryptionLog");

module.exports = async function (deployer, network, accounts) {
  const abi = CPABEEncryption.abi; // Extract ABI from the compiled contract
  const bytecode = CPABEEncryption.bytecode; // Extract Bytecode
